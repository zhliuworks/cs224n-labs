...
def get_vocab_list(file_path, source, vocab_size):
    ...
    """ 
    spm.SentencePieceTrainer.train(input=file_path, model_prefix=source, vocab_size=vocab_size)     # train the spm model; this saves .model and .vocab files 
    sp = spm.SentencePieceProcessor()                                                               # create an instance
